...
public class GunShoot : MonoBehaviour
{
    ...
    void Update()
    {
        // Check for pause state first, then inventory and reload state
        if (PauseMenu.GameIsPaused || InventoryInput.BlockNextInput || InventoryInput.InventoryOpen || isReloading)
            return;
